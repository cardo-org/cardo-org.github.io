...
Below a demo of a component tha implements a RPC service.
...
In the following we use a Julia client component and in the [Python](python.qmd) section we request the `stats` service for a pandas dataframe.
